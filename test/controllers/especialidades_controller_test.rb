...
class EspecialidadesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create especialidad" do
    assert_difference('Especialidad.count') do
      post especialidades_url, params: { especialidad: { categoria_servicio_id: @especialidad.categoria_servicio_id, codigo: @especialidad.codigo, estatus: @especialidad.estatus, nombre: @especialidad.nombre } }
    end
  ...
  test "should update especialidad" do
    patch especialidad_url(@especialidad), params: { especialidad: { categoria_servicio_id: @especialidad.categoria_servicio_id, codigo: @especialidad.codigo, estatus: @especialidad.estatus, nombre: @especialidad.nombre } }
