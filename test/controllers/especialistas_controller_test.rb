...
class EspecialistasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create especialista" do
    assert_difference('Especialista.count') do
      post especialistas_url, params: { especialista: { codigo: @especialista.codigo, descripcion: @especialista.descripcion, estatus: @especialista.estatus, nombre: @especialista.nombre } }
    end
  ...
  test "should update especialista" do
    patch especialista_url(@especialista), params: { especialista: { codigo: @especialista.codigo, descripcion: @especialista.descripcion, estatus: @especialista.estatus, nombre: @especialista.nombre } }
